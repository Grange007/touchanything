...
class NeuSVolumeRenderer(VolumeRenderer):
    ...
    def forward(
        ...
        **kwargs
        ...
        # Convert ray distance to true depth
        rays_d_norm = torch.norm(rays_d_flatten, dim=-1, keepdim=True)
        depth = depth / rays_d_norm
        ...
        if self.training:
            ...
            if "normal" in geo_out:
                if self.cfg.return_comp_normal:
                    ...
                    comp_normal_cam = (comp_normal_cam + 1.0) / 2.0
                    ...
                    out.update(
                        {
                            ...
                            "comp_normal_cam": comp_normal_cam.view(
                                batch_size, height, width, 3
                            ),  
