...
class PromptProcessorOutput:
    ...
    text_embeddings_aux: Float[Tensor, "N Nf_aux"]
    uncond_text_embeddings_aux: Float[Tensor, "N Nf_aux"]
    text_embeddings_vd_aux: Float[Tensor, "Nv N Nf_aux"]
    uncond_text_embeddings_vd_aux: Float[Tensor, "Nv N Nf_aux"]
...
class PromptProcessor(BaseObject):
    ...
    @staticmethod
    def spawn_func(pretrained_model_name_or_path, pretrained_model_name_or_path_aux, prompts, cache_dir, spawn_func):
        raise NotImplementedError
    ...
    def __call__(self) -> PromptProcessorOutput:
        return PromptProcessorOutput(
            ...
            text_embeddings_aux=self.text_embeddings_aux,
            uncond_text_embeddings_aux=self.uncond_text_embeddings_aux,
            text_embeddings_vd_aux=self.text_embeddings_vd_aux,
            uncond_text_embeddings_vd_aux=self.uncond_text_embeddings_vd_aux,
