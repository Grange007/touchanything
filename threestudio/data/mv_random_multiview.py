...
from threestudio.data.mv_uncond import (
...
class RandomMultiviewCameraIterableDataset(RandomCameraIterableDataset):
    ...
    def collate(self, batch) -> Dict[str, Any]:
        ...
        # right hand coordinate system, x back, y right, z up (default)
        if self.cfg.open3d_coord:
            # Open3D convention: x right, y up, z back
...
@register("mv-random-multiview-camera-datamodule")
